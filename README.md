...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,python,html,js,css,java,mysql,bash,powershell,vim,postman,docker,github,git,vscode,arch,linux,kali,windows,ubuntu,apple&theme=dark&perline=11)](https://skillicons.dev)
...
<image src="https://count.getloli.com/@enp7s0d?name=enp7s0d&theme=love-and-deepspace&padding=7&offset=0&align=top&scale=1&pixelated=1&darkmode=auto" alt="enp7s0d" />
